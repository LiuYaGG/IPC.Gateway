...
namespace IPC.Plc.Communication.Cip
{
    internal sealed class CipDriverOptions
    {
        ...
        public string BoolArrayMode { get; private set; } = "PackedDint";

        public bool UsesNativeBoolArrays => BoolArrayMode.Equals("NativeBool", StringComparison.OrdinalIgnoreCase);

        public string StringFormat { get; private set; } = "Logix";

        public bool UsesStandardCipString => StringFormat.Equals("CipString", StringComparison.OrdinalIgnoreCase);
        ...
        public static CipDriverOptions Parse(string json)
        {
            ...
            try
            {
                ...
                options.BoolArrayMode = GetString(root, "cipBoolArrayMode", options.BoolArrayMode);
                options.StringFormat = GetString(root, "cipStringFormat", options.StringFormat);
