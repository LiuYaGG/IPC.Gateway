...
namespace IPC.Gateway.LegacyProtocolPlugins
{
    public sealed class Dnp3ProtocolDriver : LegacyProtocolDriver
    {
        ...
        protected override IPlcClient CreateLicensedClient(PlcConnectionOptions options) => new Dnp3Client(options);
    ...
    public sealed class BeckhoffAdsProtocolDriver : LegacyProtocolDriver
    {
        ...
        protected override IPlcClient CreateLicensedClient(PlcConnectionOptions options)
        {
    ...
    public abstract class LegacyProtocolDriver : IProtocolDriver, IProtocolDriverMetadata, IPlcClientCapabilityProvider, IPlcTagDefinitionValidator
    {
        ...
        {
            LegacyPluginLicense.EnsureDriverAllowed(DriverId);
            return LicensedPlcClient.Wrap(DriverId, CreateLicensedClient(options));
        }

        protected abstract IPlcClient CreateLicensedClient(PlcConnectionOptions options);
