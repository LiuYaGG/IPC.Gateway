    ...
    public static class ProjectConfigCloner
    {
        ...
        private static FlowRuleNode? CloneFlowNode(FlowRuleNode? source)
        {
            ...
            return new FlowRuleNode
            {
                ...
                RelatedChannelId = source.RelatedChannelId,
                RelatedChannelName = source.RelatedChannelName,
                RelatedDeviceId = source.RelatedDeviceId,
                RelatedGroupId = source.RelatedGroupId,
                RelatedTagId = source.RelatedTagId,
                ...
                ContextChannelId = source.ContextChannelId,
                ContextChannelName = source.ContextChannelName,
                ContextDeviceId = source.ContextDeviceId,
                ContextGroupId = source.ContextGroupId,
                ContextTagId = source.ContextTagId,
        ...
        public static EdgeRuleConfig? CloneRule(EdgeRuleConfig? source)
        {
            ...
            return new EdgeRuleConfig
            {
                ...
                SourceTagId = source.SourceTagId,
