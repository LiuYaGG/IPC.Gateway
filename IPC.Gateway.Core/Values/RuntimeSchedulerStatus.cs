...
namespace IPC.Runtime.Values
{
    public sealed class RuntimeSchedulerStatus
    {
        ...
        public int TagValueChangedPendingCount { get; set; }
        public int TagValueChangedQueueLimit { get; set; }
        public int TagValueChangedMaxObservedPendingCount { get; set; }
        public long TotalTagValueChangedQueued { get; set; }
        public long TotalTagValueChangedDispatched { get; set; }
        public long TotalTagValueChangedDropped { get; set; }
